      ...
      >
        ...
        <g transform='translate(20, 20)'>
          ...
          <g transform='translate(30, 60)'>
            ...
            <g transform='translate(0, 0)'>
              <rect
                ...
                height='60'
                rx='4'
                className='traditional-component'
              />
              ...
              <text x='75' y='35' className='text-component'>
                Client Application
              </text>

              {/* Deploy indicator */}
              <circle cx='235' cy='30' r='16' className='deploy-indicator' />
              <text x='235' y='36' className='deploy-text' textAnchor='middle'>
                1
              </text>
            </g>
          ...
          <g transform='translate(30, 310)'>
            ...
            />
            <text x='10' y='20' className='complexity-high'>
              ⚠️ High Complexity
            </text>
            <text x='28' y='35' className='text-label'>
              3 deployments • Config • Latency
            </text>
          </g>
        </g>
        ...
        <g transform='translate(370, 20)'>
          ...
          <g transform='translate(30, 60)'>
            ...
            <g transform='translate(15, 50)'>
              ...
              <text x='37' y='40' className='text-label' textAnchor='middle'>
                Client
              </text>
              ...
              <text x='122' y='40' className='text-label' textAnchor='middle'>
                Server
              </text>
              ...
              <text x='207' y='40' className='text-label' textAnchor='middle'>
                Database
              </text>
            </g>
          ...
          <g transform='translate(30, 200)'>
            ...
            />
            <text x='31' y='20' className='text-label' textAnchor='middle'>
              Zero
            </text>
            <text x='31' y='32' className='text-label' textAnchor='middle'>
              Config
            </text>
            ...
            <rect
              ...
              className='benefit-card'
            />
            <text x='100' y='20' className='text-label' textAnchor='middle'>
              Low
            </text>
            <text x='100' y='32' className='text-label' textAnchor='middle'>
              Latency
            </text>
            ...
            <rect
              ...
              className='benefit-card'
            />
            <text x='169' y='20' className='text-label' textAnchor='middle'>
              Self
            </text>
            <text x='169' y='32' className='text-label' textAnchor='middle'>
              Contained
            </text>
            ...
            <rect
              ...
              className='benefit-card'
            />
            <text x='238' y='20' className='text-label' textAnchor='middle'>
              Run
            </text>
            <text x='238' y='32' className='text-label' textAnchor='middle'>
              Anywhere
            </text>
          </g>
          ...
          <g transform='translate(30, 310)'>
            <rect
              ...
              className='complexity-indicator'
            />
            <text x='10' y='20' className='complexity-low'>
              ✓ Low Complexity
            </text>
            <text x='24' y='35' className='text-label'>
              1 deployment • Zero config • Direct
            </text>
          </g>
        </g>
      </svg>
