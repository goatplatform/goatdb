    ...
    <Diagram>
      <svg width="720" height="280" viewBox="0 0 720 280" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(0, 0)">
          <rect x="0" y="0" width="720" height="180" rx="8" ry="8" className="timeline-box"/>
          ...
          <g transform="translate(60, 60)">
            {/* Expired commits */}
            <rect x="0" y="0" width="70" height="50" rx="2" ry="2" className="commit-expired"/>
            <text x="35" y="30" textAnchor="middle" className="text-body">C1</text>
            
            <rect x="100" y="0" width="70" height="50" rx="2" ry="2" className="commit-expired"/>
            <text x="135" y="30" textAnchor="middle" className="text-body">C2</text>
            
            <rect x="200" y="0" width="70" height="50" rx="2" ry="2" className="commit-expired"/>
            <text x="235" y="30" textAnchor="middle" className="text-body">C3</text>
            
            {/* Threshold line */}
            <line x1="310" y1="-20" x2="310" y2="70" className="threshold-line"/>
            <text x="310" y="-30" textAnchor="middle" className="text-body" fontWeight="600" fill="var(--ifm-color-danger-dark)">
              Expiration Threshold
            </text>
            
            {/* Active commits */}
            <rect x="350" y="0" width="70" height="50" rx="2" ry="2" className="commit-active"/>
            <text x="385" y="30" textAnchor="middle" className="text-body">C4</text>
            
            <rect x="450" y="0" width="70" height="50" rx="2" ry="2" className="commit-active"/>
            <text x="485" y="30" textAnchor="middle" className="text-body">C5</text>
            
            <rect x="550" y="0" width="70" height="50" rx="2" ry="2" className="commit-active"/>
            <text x="585" y="30" textAnchor="middle" className="text-body">C6</text>
          ...
          <g transform="translate(60, 150)">
            <text x="35" y="0" textAnchor="middle" className="text-body">← Older</text>
            <text x="585" y="0" textAnchor="middle" className="text-body">Newer →</text>
          </g>
        </g>
        ...
        <g transform="translate(0, 200)">
          ...
          <text x="45" y="25" className="text-body">
            <tspan fontWeight="600" fill="var(--ifm-color-primary-darker)">Smart Cleanup (Design Phase):</tspan>
            <tspan dx="5">Time-based expiration • Preserves delta chain integrity</tspan>
          </text>
          <text x="45" y="45" className="text-body">
            Removes expired commits safely • Maintains offline capabilities • Coming soon
          </text>
        </g>
      </svg>
    </Diagram>
