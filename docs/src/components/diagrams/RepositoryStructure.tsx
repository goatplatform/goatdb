        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(160, 30)'>
            ...
            <g transform='translate(20, 50)'>
              ...
              />
              <text x='10' y='20' className='text-code'>
                {`{"id":"abc123","key":"/data/users/jane", ... }`}
              </text>
              ...
              <rect
                ...
                className='commit-line'
              />
              <text x='10' y='60' className='text-code'>
                {`{"id":"def456","key":"/data/users/john", ... }`}
              </text>
              ...
              <rect
                ...
                className='commit-line'
              />
              <text x='10' y='100' className='text-code'>
                {`{"id":"ghi789","key":"/data/users/alice", ... }`}
              </text>
              ...
              <rect
                ...
                className='commit-line'
              />
              <text x='10' y='140' className='text-code'>
                {`{"id":"jkl012","key":"/data/users/bob", ... }`}
              </text>
            </g>
            ...
            <g transform='translate(20, 264)'>
              ...
              />
              <text x='10' y='20' className='text-code-result'>
                {`{"id":"mno345","key":"/data/users/carol", ... }`}
              </text>
            </g>
          </g>
