    ...
    <Diagram>
      ...
      >
        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(80, 40)'>
            ...
            <g transform='translate(20, 50)'>
              <rect
                ...
                className='db-box'
              />
              <text x='80' y='30' className='text-body' textAnchor='middle'>
                Complete
              </text>
              <text x='80' y='50' className='text-body' textAnchor='middle'>
                replica
              </text>
            </g>
          </g>
          ...
          <g>
            <path
              d='M 280 110 L 440 110'
              className='sync-line'
              markerEnd='url(#arrowhead)'
            />
            <path
              d='M 440 110 L 280 110'
              className='sync-line'
              markerEnd='url(#arrowhead)'
              transform='translate(0, 10)'
            />
            <text x='360' y='105' className='text-body' textAnchor='middle'>
              Sync
            </text>
          </g>
          ...
          <g transform='translate(30, 220)'>
            ...
            <text x='45' y='25' className='text-body'>
              ...
              <tspan dx='5'>
                Zero-latency reads • Full offline mode • Instant queries
              </tspan>
            </text>
          </g>
        </g>
