      ...
      <svg width="720" height="360" viewBox="0 0 720 360" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(0, 0)">
          ...
          <g transform="translate(40, 30)">
            <rect x="0" y="0" width="300" height="220" rx="4" ry="4" className="query-box"/>
            <text x="20" y="35" className="text-icon-small">🔍</text>
            <text x="45" y="35" className="text-heading">Query: Active Users</text>
            
            <g transform="translate(20, 65)">
              <rect x="0" y="0" width="260" height="45" rx="2" ry="2" className="result-box"/>
              <text x="130" y="28" className="text-body" textAnchor="middle">Filter: active users only</text>
            </g>
          ...
          <g transform="translate(380, 30)">
            <rect x="0" y="0" width="300" height="220" rx="4" ry="4" className="cache-box"/>
            <text x="20" y="35" className="text-icon-small">💾</text>
            ...
            <g transform="translate(20, 65)">
              ...
              <g transform="translate(0, 35)">
                <rect x="0" y="0" width="260" height="45" rx="2" ry="2" className="result-box"/>
                <text x="130" y="28" className="text-small" textAnchor="middle">[Alice, Bob, Carol] ✓</text>
              </g>
              
              <g transform="translate(0, 105)">
                <text x="0" y="15" className="text-body">Last Processed Age:</text>
                <g transform="translate(136, -5)">
                  <circle cx="15" cy="15" r="15" className="age-badge"/>
                  <text x="15" y="20" className="text-age-badge" textAnchor="middle">42</text>
                </g>
              </g>
            </g>
          </g>
          ...
          <g transform="translate(340, 140)">
            <path d="M 0 0 L 40 0" stroke="var(--ifm-color-emphasis-600)" strokeWidth="2" markerEnd="url(#arrowhead2)"/>
          </g>
          ...
          <g transform="translate(30, 270)">
            ...
            <text x="45" y="25" className="text-body">
              <tspan fontWeight="600" fill="var(--ifm-color-primary-darker)">Smart Caching:</tspan>
              <tspan dx="5">Stores results + last processed age</tspan>
            </text>
            <text x="45" y="45" className="text-body">Updates process only new commits (age {">"} 42)</text>
          </g>
        </g>
      </svg>
    </Diagram>
