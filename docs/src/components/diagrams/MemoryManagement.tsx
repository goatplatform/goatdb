        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(0, 0)'>
            ...
            <g transform='translate(220, 50)'>
              ...
              />
              <text x='40' y='35' textAnchor='middle' className='text-body'>
                repo1
              </text>
              ...
              <rect
                ...
                className='repo-active'
              />
              <text x='160' y='35' textAnchor='middle' className='text-body'>
                repo2
              </text>
              ...
              <rect
                ...
                className='repo-active'
              />
              <text x='280' y='35' textAnchor='middle' className='text-body'>
                repo3
              </text>
            </g>
          </g>
          ...
          <g transform='translate(0, 400)'>
            ...
            <g transform='translate(90, 50)'>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='120' y='30' textAnchor='middle' className='text-body'>
                repo2
              </text>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='205' y='30' textAnchor='middle' className='text-body'>
                repo3
              </text>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='290' y='30' textAnchor='middle' className='text-body'>
                repo4
              </text>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='375' y='30' textAnchor='middle' className='text-body'>
                repo5
              </text>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='460' y='30' textAnchor='middle' className='text-body'>
                repo6
              </text>
              ...
              <rect
                ...
                className='repo-inactive'
              />
              <text x='545' y='30' textAnchor='middle' className='text-body'>
                repo7
              </text>
            </g>
          </g>
          ...
          <g transform='translate(30, 560)'>
            ...
            <text x='45' y='25' className='text-body'>
              ...
              <tspan dx='5'>
                Load only what you need • Active repos in RAM
              </tspan>
            </text>
            <text x='45' y='45' className='text-body'>
              Two-way sync: RAM ↔ Disk and RAM ↔ Remote
            </text>
          </g>
        </g>
      </svg>
