      ...
      >
        <defs>
          ...
          >
            <polygon
              points='0 0, 8 3, 0 6'
              className='arrow-marker-secondary'
            />
          </marker>
          <style>
            {`
        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(0, 0)'>
            ...
            <g transform='translate(20, 60)'>
              ...
              />
              <text x='20' y='25' className='text-body'>
          ...
          <g transform='translate(320, 180)'>
            ...
            <text x='40' y='-10' textAnchor='middle' className='text-body'>
              Delta
            </text>
            <text x='40' y='20' textAnchor='middle' className='text-body'>
              Sync
            </text>
          </g>
          ...
          <g transform='translate(0, 360)'>
            ...
            <text x='45' y='25' className='text-body'>
              ...
              <tspan dx='5'>
                Delta compression • Transport agnostic • Automatic conflict
                resolution
              </tspan>
            </text>
            <text x='45' y='45' className='text-body'>
              Only missing commits transfer • No persistent state • Works over
              any channel
            </text>
          </g>
        </g>
