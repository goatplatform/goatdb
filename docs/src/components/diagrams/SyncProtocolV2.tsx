      ...
      >
        ...
        <g transform='translate(80, 80)'>
          <rect
            ...
            height='500'
            rx='8'
            className='sync-centralized-container'
          />
          <text
            x='280'
            y='50'
            className='sync-text-explanation'
            textAnchor='middle'
          >
            Traditional Sync
          </text>
          ...
          <g transform='translate(180, 190)'>
            <rect
              ...
              height='140'
              rx='16'
              className='sync-server-node'
            />
            <text x='100' y='92' className='sync-text-sub' textAnchor='middle'>
              Server
            </text>
          </g>
          ...
          <g transform='translate(80, 150)'>
            ...
            <line
              ...
              x2='105'
              y2='60'
              className='sync-coordination-line'
            />
          </g>
          ...
          <text x='290' y='550' className='sync-text-sub' textAnchor='middle'>
            All clients connect only to server
          </text>
        </g>
        ...
        <g transform='translate(820, 80)'>
          <rect
            ...
            height='500'
            rx='8'
            className='sync-distributed-container'
          />
          <text
            x='280'
            y='50'
          ...
          <text x='290' y='550' className='sync-text-sub' textAnchor='middle'>
            P2P network with distributed servers
          </text>
        </g>
        ...
        <g transform='translate(80, 600)'>
          <text x='680' y='75' className='sync-text-sub' textAnchor='middle'>
            ...
            <tspan dx='5'>
              Every device syncs directly with any other device
            </tspan>
          </text>
        </g>
      </svg>
