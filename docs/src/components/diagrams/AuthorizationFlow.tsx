  ...
  return (
    <Diagram>
      ...
      >
        ...
        <text x='400' y='30' textAnchor='middle' className='text-title'>
          GoatDB Authorization Pipeline
        </text>
        <text x='400' y='50' textAnchor='middle' className='text-body'>
          Every Operation Flows Through Authorization Rules
        </text>
        ...
        <g transform='translate(20, 80)'>
          <rect
            ...
            rx='4'
            ry='4'
            className='input-stream'
          />
          <text x='80' y='25' textAnchor='middle' className='text-heading'>
            📝 Operations
          </text>
        ...
        <g transform='translate(220, 120)'>
          <rect
            ...
            rx='60'
            ry='60'
            className='pipeline-outer'
          />
          <text x='180' y='-10' textAnchor='middle' className='text-heading'>
            🛡️ Authorization Pipeline
          </text>
          ...
          <g transform='translate(20, 20)'>
            <rect
              ...
              rx='40'
              ry='40'
              className='pipeline-chamber'
            />
            <text x='50' y='35' textAnchor='middle' className='text-icon'>
              🎯
            </text>
            <text x='50' y='55' textAnchor='middle' className='text-pipeline'>
              Pattern
            </text>
            <text x='50' y='70' textAnchor='middle' className='text-pipeline'>
              Match
            </text>
          </g>
        ...
        <g transform='translate(620, 80)'>
          ...
          <g transform='translate(0, 0)'>
            <rect
              ...
              rx='4'
              ry='4'
              className='allow-channel'
            />
            <text x='80' y='30' textAnchor='middle' className='text-icon-small'>
              ✅
            </text>
            <text
              x='80'
              y='55'
              textAnchor='middle'
              className='text-heading text-allow'
            >
              Allowed
            </text>
            <text x='80' y='75' textAnchor='middle' className='text-small'>
              Access granted
            </text>
          </g>
          ...
          <g transform='translate(0, 130)'>
            ...
            <text
              ...
              y='55'
              textAnchor='middle'
              className='text-heading text-deny'
            >
              Denied
            </text>
            <text x='80' y='75' textAnchor='middle' className='text-small'>
        ...
        <g transform='translate(20, 350)'>
          ...
          <text x='45' y='30' className='text-body'>
            ...
            <tspan dx='5'>
              Pattern matching → Rule execution → Boolean decision • Applied to
              every operation
            </tspan>
          </text>
        </g>
