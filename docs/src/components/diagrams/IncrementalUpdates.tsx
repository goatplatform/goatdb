    ...
    <Diagram>
      <svg width="720" height="420" viewBox="0 0 720 420" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(0, 0)">
          ...
          {/* Header */}
          <text x="30" y="40" className="text-heading">Query Incremental Updates</text>
          
          {/* Timeline */}
          <g transform="translate(30, 70)">
            <rect x="0" y="0" width="660" height="120" rx="4" ry="4" className="timeline-box"/>
            ...
            <g transform="translate(20, 50)">
              {[0, 1, 2, 3, 4].map((i) => (
                <g key={i} transform={`translate(${i * 80}, 0)`}>
                  <rect x="0" y="0" width="60" height="40" rx="2" ry="2" className="old-commit"/>
                  <text x="30" y="25" className="text-label" textAnchor="middle">Age {i + 1}</text>
                </g>
              ))}
              
              {/* Marker line */}
              <line x1="390" y1="-20" x2="390" y2="50" className="skip-line"/>
              <text x="390" y="-25" className="text-label" textAnchor="middle">Last processed</text>
              
              {/* New commits */}
              {[5, 6, 7].map((i) => (
                <g key={i} transform={`translate(${i * 80}, 0)`}>
                  <rect x="0" y="0" width="60" height="40" rx="2" ry="2" className="new-commit"/>
                  <text x="30" y="25" className="text-label-new" textAnchor="middle">Age {i + 1}</text>
                </g>
              ))}
            </g>
          </g>
          ...
          <g transform="translate(360, 210)">
            ...
            <text x="20" y="40" className="text-body">Skip 1-5, process 6-8</text>
          </g>
          
          {/* Query box */}
          <g transform="translate(180, 270)">
            <rect x="0" y="0" width="360" height="80" rx="4" ry="4" className="timeline-box"/>
            <text x="20" y="30" className="text-icon-small">🔄</text>
            <text x="45" y="30" className="text-heading">Query Update Process</text>
            <text x="45" y="55" className="text-body">Resume from Age 6 → Process commits 6, 7, 8</text>
          </g>
          
          {/* Arrow marker */}
          <defs>
            <marker id="arrowhead3" markerWidth="10" markerHeight="10" refX="5" refY="5" orient="auto">
              <polygon points="0 2.5, 7.4 5, 0 7.5" fill="var(--ifm-color-primary)"/>
            </marker>
          </defs>
          ...
          <g transform="translate(30, 370)">
            ...
            <text x="45" y="25" className="text-body">
              <tspan fontWeight="600" fill="var(--ifm-color-primary-darker)">Incremental Updates:</tspan>
              <tspan dx="5">Skip old commits • Process only new changes • Much faster than full scan</tspan>
            </text>
          </g>
        </g>
      </svg>
