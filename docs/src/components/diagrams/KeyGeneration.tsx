      ...
      >
        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(20, 30)'>
            ...
            />
            <text x='120' y='30' className='text-icon' textAnchor='middle'>
              💻
            </text>
            <text x='120' y='55' className='text-heading' textAnchor='middle'>
              Peer Machine
            </text>
            ...
            <text x='120' y='190' className='text-body' textAnchor='middle'>
              Never leaves
            </text>
            <text x='120' y='210' className='text-body' textAnchor='middle'>
              the machine
            </text>
          </g>
          ...
          <g transform='translate(340, 30)'>
            ...
            />
            <text x='180' y='30' className='text-icon' textAnchor='middle'>
              🌐
            </text>
            <text x='180' y='55' className='text-heading' textAnchor='middle'>
              GoatDB Network
            </text>
            ...
            <g transform='translate(190, 80)' className='session-box'>
              ...
              <text x='40' y='25' className='text-heading text-primary'>
                Session
              </text>
              <text x='75' y='45' className='text-small' textAnchor='middle'>
                30 day expiration
            ...
            <g transform='translate(20, 165)'>
              ...
              <text x='55' y='43' className='text-small'>
                Tied to User ID & Peer Machine
              </text>

              <text x='20' y='68' className='text-icon-small' opacity='0.6'>
                ❓
              </text>
              <text x='45' y='68' className='text-body'>
                <tspan fontWeight='500'>Anonymous Session:</tspan>
              </text>
              <text x='55' y='86' className='text-small'>
                Tied only to Peer Machine
              </text>
            </g>
          </g>
          ...
          <g transform='translate(30, 330)'>
            ...
            <text x='45' y='45' className='text-body'>
              Auto-rotation via expiration • Manual revocation available
            </text>
          </g>
        </g>
      </svg>
