        ...
        <g transform='translate(0, 0)'>
          ...
          <g transform='translate(30, 30)'>
            ...
            <g transform='translate(20, 60)'>
              ...
              <g transform='translate(30, 40)'>
                ...
                <text x='30' y='55' className='text-label' textAnchor='middle'>
                  v1
                </text>
                ...
                <text x='70' y='55' className='text-label' textAnchor='middle'>
                  v2
                </text>
                ...
                <text x='110' y='55' className='text-label' textAnchor='middle'>
                  v3
                </text>
                ...
                <text x='150' y='55' className='text-label' textAnchor='middle'>
                  v4
                </text>
              </g>
            </g>
            ...
            <g transform='translate(340, 60)'>
              ...
              <g transform='translate(30, 40)'>
                ...
                <text x='70' y='-5' className='text-label' textAnchor='middle'>
                  v2a
                </text>
                ...
                <text x='70' y='70' className='text-label' textAnchor='middle'>
                  v2b
                </text>
          ...
          <g transform='translate(30, 400)'>
            ...
            <text x='45' y='45' className='text-body'>
              Automatic conflict resolution • Parallel evolution
            </text>
          </g>
        </g>
      </svg>
