    ...
    <section className={styles.useCases}>
      <div className="container">
        ...
        <p className={styles.tradeoffNote}>
          GoatDB trades raw query performance for developer experience. 
          If you need sub-100ms queries on millions of rows, use PostgreSQL.
          <br />
        ...
        <div className={styles.openSourceContent}>
          ...
          <p className={styles.openSourceStats}>
            <a href="https://github.com/goatplatform/goatdb/stargazers">
              <img src="https://img.shields.io/github/stars/goatplatform/goatdb?style=social" alt="GitHub stars" />
            </a>
            {' '}
            <a href="https://github.com/goatplatform/goatdb/network/members">
              <img src="https://img.shields.io/github/forks/goatplatform/goatdb?style=social" alt="GitHub forks" />
            </a>
          </p>
        </div>
      </div>
