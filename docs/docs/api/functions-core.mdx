...
**<code>itemPathGetPart(path: string, part: 'type' | 'repo' | 'item' | 'embed'): T</code>**
...
**<code>prettyJSON(o: ReadonlyJSONValue): string</code>**
...
**<code>SchemaEquals(s1: [Schema](/docs/api/types/schema), s2: [Schema](/docs/api/types/schema)): boolean</code>**

Given two schemas, returns whether they're the same one or not.

## SchemaGetFieldDef

**<code>SchemaGetFieldDef(s: S, field: F): [FieldDef](/docs/api/types/fielddef)&lt;S['fields'][F]['type']&gt;</code>**

Given a schema and a field, returns its

## SchemaGetFields

**<code>SchemaGetFields(s: [Schema](/docs/api/types/schema)): readonly [string, [FieldDef](/docs/api/types/fielddef)&lt;ValueType&gt;][]</code>**

Given a schema, this function returns its field definitions as an iterable.

## SchemaGetRequiredFields

**<code>SchemaGetRequiredFields(s: [Schema](/docs/api/types/schema)): readonly string[]</code>**
