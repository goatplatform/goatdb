...
**<code>useDB(): [GoatDB](/docs/api/classes/goatdb)&lt;US&gt;</code>**
...
**<code>useDBReady(): [DBReadyState](/docs/api/types/dbreadystate)</code>**
...
**<code>useItem(pathComps: string[]): [ManagedItem](/docs/api/classes/manageditem)&lt;S, [Schema](/docs/api/types/schema)&gt;</code>**
...
**<code>useQuery(config: [UseQueryOpts](/docs/api/interfaces/usequeryopts)&lt;IS, CTX, OS&gt;): [Query](/docs/api/classes/query)&lt;IS, OS, CTX&gt;</code>**
