...
**<code>new Query(config: [QueryConfig](/api/types/queryconfig)&lt;IS, OS, CTX&gt;)</code>**
...
**<code>entries(): Generator&lt;[Entry](/api/types/entry)&lt;OS&gt;&gt;</code>**
...
**<code>find(fieldName: keyof OS[any], value: [SchemaDataType](/api/types/schemadatatype)&lt;OS&gt;[keyof OS[any]]): [ManagedItem](/api/classes/manageditem)&lt;OS, [Schema](/api/types/schema)&gt;</code>**
...
**<code>loadingFinished(): Promise&lt;any&gt;</code>**
...
**<code>results(): readonly [ManagedItem](/api/classes/manageditem)&lt;OS, [Schema](/api/types/schema)&gt;[]</code>**
...
**<code>valueForPath(key: string): [Item](/api/classes/item)&lt;OS&gt;</code>**
