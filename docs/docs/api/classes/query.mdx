...
**find(fieldName: keyof `OS`[any], value: [SchemaDataType](./types/schemadatatype)\<`OS`\>[keyof `OS`[any]]): [ManagedItem](./classes/manageditem)\<`OS`, [Schema](./types/schema)\>**
...
**results(): readonly [ManagedItem](./classes/manageditem)\<`OS`, [Schema](./types/schema)\>[]**
