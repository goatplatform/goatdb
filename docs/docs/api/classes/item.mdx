...
**<code>new Item(config: ItemConfig&lt;S&gt; | ConstructorDecoderConfig&lt;EncodedItem&gt;, registry: [DataRegistry](/api/classes/dataregistry)&lt;&gt;)</code>**
...
**<code>cloneData(onlyFields: keyof S['fields'][]): Readwrite&lt;[SchemaDataType](/api/types/schemadatatype)&lt;S&gt;&gt;</code>**
