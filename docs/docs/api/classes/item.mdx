...
**Implements:** [ReadonlyItem](/api/interfaces/readonlyitem), [Encodable](/api/interfaces/encodable)

## Constructor

**<code>new Item(config: ItemConfig&lt;S&gt; | [ConstructorDecoderConfig](/api/interfaces/constructordecoderconfig)&lt;EncodedItem&gt;, registry: [DataRegistry](/api/classes/dataregistry)&lt;&gt;)</code>**
...
**<code>clone(): [Item](/api/classes/item)&lt;S&gt;</code>**
...
**<code>cloneData(onlyFields: keyof S[any][]): Readwrite&lt;[SchemaDataType](/api/types/schemadatatype)&lt;S&gt;&gt;</code>**

Creates a deep copy of the item's data.

### copyFrom()

**<code>copyFrom(doc: [Item](/api/classes/item)&lt;S&gt; | [ReadonlyItem](/api/interfaces/readonlyitem)&lt;S&gt;): void</code>**
...
**<code>dataUnsafe(): [SchemaDataType](/api/types/schemadatatype)&lt;S&gt;</code>**
...
**<code>diff(other: [Item](/api/classes/item)&lt;S&gt;, byCharacter: boolean): DataChanges&lt;&gt;</code>**
...
**<code>diffKeys(other: [Item](/api/classes/item)&lt;S&gt;, local: boolean): string[]</code>**
...
**<code>get(key: T): [SchemaDataType](/api/types/schemadatatype)&lt;S&gt;[T]</code>**
...
**<code>isEqual(other: [Item](/api/classes/item)&lt;S&gt;): boolean</code>**
...
**<code>serialize(encoder: [Encoder](/api/interfaces/encoder)&lt;string, [CoreValue](/api/types/corevalue)&gt;, options: &#123; local: boolean &#125;): void</code>**
...
**<code>set(key: T, value: [SchemaDataType](/api/types/schemadatatype)&lt;S&gt;[T]): void</code>**
...
**<code>toJS(local: boolean): [ReadonlyJSONObject](/api/interfaces/readonlyjsonobject)</code>**
...
**<code>upgradeSchema(newSchema: [Schema](/api/types/schema)): boolean</code>**
...
**<code>fromJS(obj: [ReadonlyJSONObject](/api/interfaces/readonlyjsonobject)): [Item](/api/classes/item)&lt;S&gt;</code>**

Deserializes a JSON-compatible object into an Item instance.

### nullItem()

**<code>nullItem(registry: [DataRegistry](/api/classes/dataregistry)&lt;&gt;): [Item](/api/classes/item)&lt;S&gt;</code>**
