...
**<code>new Server(options: [ServerOptions](/api/interfaces/serveroptions)&lt;US&gt;)</code>**
...
**<code>registerEndpoint(ep: [Endpoint](/api/interfaces/endpoint)&lt;US&gt;): void</code>**

Registers an endpoint handler with the server.

### registerMiddleware()

**<code>registerMiddleware(mid: [Middleware](/api/interfaces/middleware)&lt;US&gt;): void</code>**

Registers a middleware handler with the server.

### servicesForOrganization()

**<code>servicesForOrganization(orgId: string): Promise&lt;[ServerServices](/api/interfaces/serverservices)&lt;US&gt;&gt;</code>**
