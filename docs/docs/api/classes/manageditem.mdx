...
**<code>new ManagedItem(db: [GoatDB](/docs/api/classes/goatdb)&lt;US&gt;, path: string)</code>**
...
**<code>get(key: any): [SchemaDataType](/docs/api/types/schemadatatype)&lt;S&gt;[K]</code>**
...
**<code>set(key: any, value: [SchemaDataType](/docs/api/types/schemadatatype)&lt;S&gt;[T]): void</code>**
