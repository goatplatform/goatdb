...
**create(path: string, schema: S, data: `Partial\<[SchemaDataType](./types/schemadatatype)\<S\>\>`): [ManagedItem](./classes/manageditem)\<S, [Schema](./types/schema)\>**
...
**item(pathComps: string[]): [ManagedItem](./classes/manageditem)\<S, [Schema](./types/schema)\>**
...
**load(path: string, schema: S, data: [SchemaDataType](./types/schemadatatype)\<S\>): `Promise`\<void\>**
...
**open(path: string, opts: `OpenOptions`): `Promise`\<[Repository](./classes/repository)\<`MemRepoStorage`\<\>\>\>**
...
**query(config: `Omit\<`QueryConfig`\<`IS`, `OS`, `CTX`\>, any\>`): [Query](./classes/query)\<`IS`, `OS`, `CTX`\>**
...
**repository(pathComps: string[]): [Repository](./classes/repository)\<`MemRepoStorage`\<\>\>**
