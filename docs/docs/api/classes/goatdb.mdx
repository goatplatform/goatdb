...
**<code>new GoatDB(config: [DBInstanceConfig](/docs/api/interfaces/dbinstanceconfig))</code>**
...
**<code>create(path: string, schema: S, data: Partial&lt;[SchemaDataType](/docs/api/types/schemadatatype)&lt;S&gt;&gt;): [ManagedItem](/docs/api/classes/manageditem)&lt;S&gt;</code>**
...
**<code>getTrustPool(): Promise&lt;[TrustPool](/docs/api/classes/trustpool)&lt;&gt;&gt;</code>**
...
**<code>item(pathComps: string[]): [ManagedItem](/docs/api/classes/manageditem)&lt;S&gt;</code>**
...
**<code>load(path: string, schema: S, data: [SchemaDataType](/docs/api/types/schemadatatype)&lt;S&gt;): Promise&lt;void&gt;</code>**
...
**<code>open(path: string, opts: OpenOptions): Promise&lt;[Repository](/docs/api/classes/repository)&lt;MemRepoStorage&lt;&gt;&gt;&gt;</code>**
...
**<code>query(config: Omit&lt;[QueryConfig](/docs/api/types/queryconfig)&lt;IS, OS, CTX&gt;, 'db'&gt;): [Query](/docs/api/classes/query)&lt;IS, OS, CTX&gt;</code>**
...
**<code>repository(pathComps: string[]): [Repository](/docs/api/classes/repository)&lt;MemRepoStorage&lt;&gt;&gt;</code>**
...
**<code>sync(path: string): Promise&lt;SyncResult&gt;</code>**
...
**<code>syncAll(): Promise&lt;Record&lt;string, SyncResult&gt;&gt;</code>**
