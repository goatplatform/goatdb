...
**<code>new GoatDB(config: DBInstanceConfig)</code>**
...
**<code>open(path: string, opts: OpenOptions): Promise&lt;[Repository](/api/classes/repository)&lt;MemRepoStorage&lt;&gt;&gt;&gt;</code>**
...
**<code>query(config: Omit&lt;QueryConfig&lt;IS, OS, CTX&gt;, 'db'&gt;): [Query](/api/classes/query)&lt;IS, OS, CTX&gt;</code>**
...
**<code>repository(pathComps: string[]): [Repository](/api/classes/repository)&lt;MemRepoStorage&lt;&gt;&gt;</code>**
