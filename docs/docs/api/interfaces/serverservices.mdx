...
**Extends:** [ServerOptions](/docs/api/interfaces/serveroptions)
...
### From [ServerOptions](/docs/api/interfaces/serveroptions)
...
*See [ServerOptions](/docs/api/interfaces/serveroptions) for detailed documentation*
