...
**<code>compile(options: [CompileOptions](/docs/api/types/compileoptions)): Promise&lt;void&gt;</code>**
...
**<code>startDebugServer(options: [DebugServerOptions](/docs/api/types/debugserveroptions)&lt;US&gt;): Promise&lt;never&gt;</code>**
...
**<code>staticAssetsFromJS(encodedAssets: [ReadonlyJSONObject](/docs/api/interfaces/readonlyjsonobject)): StaticAssets</code>**
