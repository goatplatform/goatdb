...
**<code>SchemaGetFieldDef(s: S, field: F): [FieldDef](/api/types/fielddef)&lt;S['fields'][F]['type']&gt;</code>**

Given a schema and a field, returns its

## SchemaGetFields

**<code>SchemaGetFields(s: [Schema](/api/types/schema)): readonly [string, [FieldDef](/api/types/fielddef)&lt;ValueType&gt;][]</code>**
