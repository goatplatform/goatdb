...
**<code>new TrustPool(orgId: string, currentSession: OwnedSession, roots: Session[], trustedSessions: Session[], changeCallback: () =&gt; void)</code>**

## Methods

### addSession()

**<code>addSession(s: Session, commit: Commit&lt;&gt;): Promise&lt;boolean&gt;</code>**
...
**<code>addSessionUnsafe(s: Session): boolean</code>**
...
**<code>getSession(id: string): Session</code>**

### sessions()

**<code>sessions(): Generator&lt;Session&gt;</code>**

### verify()

**<code>verify(commit: Commit&lt;&gt;): Promise&lt;boolean&gt;</code>**
