...
**<code>find(fieldName: keyof OS['fields'], value: [SchemaDataType](/api/types/schemadatatype)&lt;OS&gt;[keyof OS['fields']]): [ManagedItem](/api/classes/manageditem)&lt;OS, [Schema](/api/types/schema)&gt;</code>**
